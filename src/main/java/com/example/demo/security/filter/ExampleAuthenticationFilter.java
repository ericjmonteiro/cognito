...
public class ExampleAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
  ...
  public ExampleAuthenticationFilter(
  ...
  public Authentication attemptAuthentication(
    ...
    ExampleAuthenticationRequest authenticationRequest =
        objectMapper.readValue(request.getInputStream(), ExampleAuthenticationRequest.class);
