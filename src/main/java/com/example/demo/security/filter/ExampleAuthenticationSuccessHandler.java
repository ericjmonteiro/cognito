...
public class ExampleAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(
    ...
    tokenMap.put(
        "expiresIn", cognitoAuthenticationResultHolder.getAuthResult().getExpiresIn().toString());
    tokenMap.put(
        "refreshToken", cognitoAuthenticationResultHolder.getAuthResult().getRefreshToken());
