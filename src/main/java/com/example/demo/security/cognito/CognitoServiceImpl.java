package com.example.demo.security.cognito;
...
public class CognitoServiceImpl implements CognitoService {
  ...
  @Autowired private AWSCognitoIdentityProvider cognitoIdentityProvider;
  ...
  public AdminInitiateAuthResult initializeAuthentication(Map<String, String> authParams) {
    ...
    try {
      ...
      String message =
          "Error in User Authentication. ".concat(notAuthorizedException.getErrorMessage());
      logger.log(Level.INFO, message);
      throw new AuthenticationFailedException(message);
    } catch (UserNotFoundException userNotFoundException) {
      String message =
          "Error in User Authentication. ".concat(userNotFoundException.getErrorMessage());
      logger.log(Level.INFO, message);
      throw new AuthenticationFailedException(message);
    } catch (PasswordResetRequiredException passwordResetRequiredException) {
      String message =
          "Error in User Authentication. ".concat(passwordResetRequiredException.getErrorMessage());
      logger.log(Level.INFO, message);
      throw new AuthenticationFailedException(message);
    }
    return authResult;
  ...
  public List<String> getUserGroups(String username) {
    ...
    try {
      AdminListGroupsForUserRequest listGroupsForUserRequest =
  ...
  public User createUser(User user) {
    ...
    createUserRequest
        .getUserAttributes()
        .add(new AttributeType().withName("email_verified").withValue("false"));
    ...
    try {
      ...
      String message =
          "Error in creating the User. ".concat(usernameExistsException.getErrorMessage());
      logger.log(Level.INFO, message);
      throw new UsernameExistsException(usernameExistsException.getErrorMessage());
    } catch (InvalidPasswordException invalidPasswordException) {
      String message =
          "Error in creating the User. ".concat(invalidPasswordException.getErrorMessage());
      logger.log(Level.INFO, message);
  ...
  public User updateUser(User user) {
    try {
      if (user != null) {
        ...
        AdminUpdateUserAttributesRequest updateUserAttributeRequest =
        ...
        AdminUpdateUserAttributesResult updateUserAttributesResult =
            cognitoIdentityProvider.adminUpdateUserAttributes(updateUserAttributeRequest);
      ...
      String message =
          "Error in updating the User. ".concat(usernameExistsException.getErrorMessage());
      logger.log(Level.INFO, message);
      throw new UsernameExistsException(usernameExistsException.getErrorMessage());
    } catch (Exception exception) {
  ...
  public boolean resetPassword(String username, String previousPassword, String proposedPassword) {
    ...
    if (challengeName != null
      ...
      AdminRespondToAuthChallengeResult challengeResult =
  ...
  public boolean addUserToGroup(String username, String groupName) {
    ...
    try {
      ...
      String message =
          "Error in assiging group to the User. "
              .concat(resourceNotFoundException.getErrorMessage());
      logger.log(Level.INFO, message);
      return false;
    } catch (UserNotFoundException userNotFoundException) {
      String message =
          "Error in assiging group to the User. ".concat(userNotFoundException.getErrorMessage());
      logger.log(Level.INFO, message);
      return false;
    }
    return true;
  ...
  public List<GroupType> listUserGroups(User user) {
    AdminListGroupsForUserRequest listGroupsForUserRequest =
        new AdminListGroupsForUserRequest()
            .withUserPoolId(cognitoConfiguration.getUserPoolId())
            .withUsername(user.getUser().getUsername());

    try {
      AdminListGroupsForUserResult listGroupsForUserResult =
          cognitoIdentityProvider.adminListGroupsForUser(listGroupsForUserRequest);
      if (listGroupsForUserResult != null) return listGroupsForUserResult.getGroups();
      else return null;
    } catch (ResourceNotFoundException resourceNotFoundException) {
      String message =
          "Error in assiging group to the User. "
  ...
  public boolean removeUserFromGroup(String username, String groupName) {
    AdminRemoveUserFromGroupRequest removeUserToGroupRequest =
        new AdminRemoveUserFromGroupRequest()
            .withUserPoolId(cognitoConfiguration.getUserPoolId())
            .withUsername(username)
            .withGroupName(groupName);
    try {
      AdminRemoveUserFromGroupResult removeUserFromGroupResult =
          cognitoIdentityProvider.adminRemoveUserFromGroup(removeUserToGroupRequest);
  ...
  public boolean enableUser(User user) {
    if (user != null) {
      AdminEnableUserRequest enableUserRequest =
