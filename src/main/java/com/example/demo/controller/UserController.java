...
public class UserController {
  ...
  public ResponseEntity<?> createUser(@RequestBody User user) {
    ...
    try {
      ...
      response =
          new ResponseEntity<String>(exception.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    return response;
  }
  ...
  public ResponseEntity<?> forgotPassword(@RequestParam(name = "username") String username) {
    ...
    try {
      ...
      else response = new ResponseEntity<Object>(HttpStatus.INTERNAL_SERVER_ERROR);
    } catch (Exception exception) {
  ...
  public boolean resetPassword(@RequestBody String json) throws Exception {
    ...
    try {
      ...
      String oldPassword =
          (!credentials.isNull("oldPassword")) ? credentials.getString("oldPassword") : "";
      String newPassword =
          (!credentials.isNull("newPassword")) ? credentials.getString("newPassword") : "";
      String confirmationCode =
          (!credentials.isNull("confirmationCode"))
              ? credentials.getString("confirmationCode")
              : "";

      if (username.equals("")
          || (oldPassword.equals("") && confirmationCode.equals(""))
          || newPassword.equals("")) {
